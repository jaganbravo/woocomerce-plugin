<?php
/**
 * Loader for Unmai Analytix WooCommerce plugin.
 *
...
require_once DATAVIZ_AI_WC_PLUGIN_DIR . 'includes/class-dataviz-ai-question-suggestions.php';
...
class Dataviz_AI_Loader {
	 ...
	 * @var string
	 */
	protected $plugin_name = 'unmai-analytix-for-woocommerce';
